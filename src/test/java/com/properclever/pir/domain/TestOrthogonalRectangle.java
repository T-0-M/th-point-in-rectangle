...
public class TestOrthogonalRectangle {
    ...
    public void testValidRectangleOrderedPoints() {
        ...
        OrthogonalRectangle rectangle = new OrthogonalRectangle(points);
    ...
    public void testUnorderedPointsShouldBeInvalid() {
        ...
        Exception exception = assertThrows(IllegalArgumentException.class, () -> new OrthogonalRectangle(points));
        assertTrue(exception.getMessage().contains("Points do not form a valid orthogonal rectangle"));
    }
